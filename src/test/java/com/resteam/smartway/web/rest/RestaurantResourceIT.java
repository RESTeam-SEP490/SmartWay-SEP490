...
import com.resteam.smartway.IntegrationTest;
...
class RestaurantResourceIT {
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(DEFAULT_NAME).email(DEFAULT_EMAIL);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(UPDATED_NAME).email(UPDATED_EMAIL);
        return restaurant;
    }
    ...
    void putExistingRestaurant() throws Exception {
        ...
        updatedRestaurant.name(UPDATED_NAME).email(UPDATED_EMAIL);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.name(UPDATED_NAME).email(UPDATED_EMAIL);

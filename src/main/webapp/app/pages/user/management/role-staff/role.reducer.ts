...
import { defaultValue, IRole } from 'app/shared/model/role';
...
export const getEntities = createAsyncThunk('role/fetch_entity_list', async ({ sort, page, size }: IQueryParams) => {
  return axios.get<IRole[]>(apiUrl);
});

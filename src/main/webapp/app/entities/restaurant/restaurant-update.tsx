  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="smartWayApp.restaurant.home.createOrEditLabel" data-cy="RestaurantCreateUpdateHeading">
            <Translate contentKey="smartWayApp.restaurant.home.createOrEditLabel">Create or edit a Restaurant</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('smartWayApp.restaurant.name')}
                id="restaurant-name"
                name="name"
                data-cy="name"
                type="text"
              />
              <ValidatedField
                label={translate('smartWayApp.restaurant.email')}
                id="restaurant-email"
                name="email"
                data-cy="email"
                type="text"

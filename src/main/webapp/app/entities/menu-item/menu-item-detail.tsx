  ...
  return (
    <>
      <Tabs className="p-2" defaultValue={1}>
            ...
            <Form colon layout="vertical" className="flex-grow ml-6">
              ...
              <div className="pb-4">
                <div className="flex gap-2">
                  {menuItem.isActive ? (
                    <>
                      <CheckSquareFilled rev={''} className="text-lg text-green-500" />
                      <Translate contentKey="menuItem.isActive.label" />
                    </>
                  ) : (
                    <>
                      <CloseSquareFilled rev={''} className="text-lg text-red-500" />
                      <Translate contentKey="menuItem.isActive.label" />
                    </>
                  )}
                </div>
        ...
        <Tabs.TabPane tab={translate('menuItem.infoTabs.sold')} key={2}></Tabs.TabPane>

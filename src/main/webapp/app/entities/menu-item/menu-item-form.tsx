...
import { Button, Form, Image, Input, InputNumber, Modal, Tabs, Upload, message } from 'antd';
          ...
          <Tabs className="p-2">
            <Tabs.TabPane tab={translate('menuItem.infoTabs.information')} key={1} className="flex gap-8 p-2">
              <div className="flex-grow">
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    { max: 50, message: translate('entity.validation.max', { max: 30 }) },
                  ]}
                >
                  <Input />
                </Form.Item>
                ...
                <Form.Item
                  ...
                  name={'description'}
                  className="h-full"
                  rules={[{ max: 254, message: translate('entity.validation.max', { max: 30 }) }]}
                >
              ...
              <div className="h-max w-80">
                ...
                <Form.Item labelCol={{ span: 10 }} label={translate('menuItem.image.placeholder')} name={'image'}>
                      ...
                      >
                        {imageUrl.length === 0 && (
                          <Button icon={<PlusOutlined rev={''} />}>
                            <Translate contentKey="menuItem.image.label" />
                          </Button>
                        )}
                      </Upload>
                    </ImgCrop>

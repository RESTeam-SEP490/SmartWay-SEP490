...
@Mapper(componentModel = "spring", uses = { ItemCancellationNotificationMapper.class, ReadyToServeNotificationInIANMapper.class })
    ...
    @Mappings(
        {
            ...
            @Mapping(target = "orderCode", source = "orderDetail.order.code"),

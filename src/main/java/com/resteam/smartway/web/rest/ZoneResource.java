...
public class ZoneResource {
    ...
    @GetMapping
    @PostAuthorize("hasAnyAuthority('ROLE_ADMIN', 'PERMISSION_ZONE_VIEW')")
    ...
    @PostMapping
    @PostAuthorize("hasAnyAuthority('ROLE_ADMIN', 'PERMISSION_ZONE_CREATE')")
    ...
    @PutMapping("/{id}")
    @PostAuthorize("hasAnyAuthority('ROLE_ADMIN', 'PERMISSION_ZONE_EDIT')")
    ...
    @DeleteMapping("/{id}")
    @PostAuthorize("hasAnyAuthority('ROLE_ADMIN', 'PERMISSION_ZONE_DELETE')")
